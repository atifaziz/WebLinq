...
namespace WebLinq.Html
{
    ...
    public abstract partial class HtmlObject
    {
        ...
        public virtual string InnerText => InnerTextSource.Decoded ?? string.Empty;
        ...
        HashSet<string> Classes => _classes ??= new HashSet<string>(Class.Split(' '));
        public string Class => _class ??= GetAttributeValue("class") ?? string.Empty;
