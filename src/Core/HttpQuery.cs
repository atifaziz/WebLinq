...
namespace WebLinq
{
    ...
    public static class HttpQuery
    {
        ...
        static IHttpObservable Submit(IObservable<HttpFetch<ParsedHtml>> query, string formSelector, int? formIndex, Uri url, IFormSubmission<Unit> data) =>
            HttpObservable.Return(
                from html in query
                select Submit(html.Client, html.Content, formSelector, formIndex, url, _ => data));

        public static IHttpObservable Submit(this IHttpClient http, ParsedHtml html, string formSelector, IFormSubmission<Unit> data) =>
            Submit(http, html, formSelector, null, null, _ => data);

        public static IHttpObservable Submit(this IHttpClient http, ParsedHtml html, int formIndex, IFormSubmission<Unit> data) =>
            Submit(http, html, null, formIndex, null, _ => data);

        public static IHttpObservable SubmitTo(this IHttpClient http, Uri url, ParsedHtml html, string formSelector, IFormSubmission<Unit> data) =>
            Submit(http, html, formSelector, null, url, _ => data);

        public static IHttpObservable SubmitTo(this IHttpClient http, Uri url, ParsedHtml html, int formIndex, IFormSubmission<Unit> data) =>
            Submit(http, html, null, formIndex, url, _ => data);

        public static IHttpObservable Submit(this IHttpClient http, ParsedHtml html, string formSelector, Func<HtmlForm, IFormSubmission<Unit>> data) =>
            Submit(http, html, formSelector, null, null, data);

        public static IHttpObservable Submit(this IHttpClient http, ParsedHtml html, int formIndex, Func<HtmlForm, IFormSubmission<Unit>> data) =>
            Submit(http, html, null, formIndex, null, data);

        public static IHttpObservable SubmitTo(this IHttpClient http, Uri url, ParsedHtml html, string formSelector, Func<HtmlForm, IFormSubmission<Unit>> data) =>
            Submit(http, html, formSelector, null, url, data);

        public static IHttpObservable SubmitTo(this IHttpClient http, Uri url, ParsedHtml html, int formIndex, Func<HtmlForm, IFormSubmission<Unit>> data) =>
        ...
        internal static IHttpObservable Submit<T>(IHttpClient http,
            ParsedHtml html,
            string formSelector, int? formIndex, Uri actionUrl,
            Func<HtmlForm, IFormSubmission<T>> submissions)
        {
            var forms =
