...
namespace WebLinq
{
    ...
    public static class HttpModule
    {
        ...
        public static HttpQuery Get(this HttpQuery query, Uri url) =>
            HttpQuery.Return(
                from first in query
                select first.Client.Get(url));

        public static IObservable<HttpFetch<string>> Text(this HttpQuery query) =>
            query.WithReader(f => f.Content.ReadAsStringAsync());

        public static HttpQuery Get(this IHttpClient http, Uri url) =>
            HttpQuery.Return(options =>
                // TODO Use DeferAsync
                Observable.Defer(() => SendAsync(http, http.Config, 0, HttpMethod.Get, url, options: options).ToObservable()));

        public static HttpQuery Post(this HttpQuery query, Uri url, NameValueCollection data) =>
            HttpQuery.Return(
                from f in query
                select f.Client.Post(url, data));

        public static HttpQuery Post(this HttpQuery query, Uri url, HttpContent content) =>
            HttpQuery.Return(
                from f in query
                select f.Client.Post(url, content));

        public static HttpQuery Post(this IHttpClient http, Uri url, NameValueCollection data) =>
        ...
        public static HttpQuery Post(this IHttpClient http, Uri url, HttpContent content) =>
            HttpQuery.Return(options =>
                // TODO Use DeferAsync
        ...
        public static HttpQuery Accept(this HttpQuery query, params string[] mediaTypes) =>
        ...
        public static HttpQuery Submit(this IObservable<HttpFetch<ParsedHtml>> query, string formSelector, NameValueCollection data) =>
            Submit(query, formSelector, null, null, data);

        public static HttpQuery Submit(this IObservable<HttpFetch<ParsedHtml>> query, int formIndex, NameValueCollection data) =>
            Submit(query, null, formIndex, null, data);

        public static HttpQuery SubmitTo(this IObservable<HttpFetch<ParsedHtml>> query, Uri url, string formSelector, NameValueCollection data) =>
            Submit(query, formSelector, null, url, data);

        public static HttpQuery SubmitTo(this IObservable<HttpFetch<ParsedHtml>> query, Uri url, int formIndex, NameValueCollection data) =>
            Submit(query, null, formIndex, url, data);

        static HttpQuery Submit(IObservable<HttpFetch<ParsedHtml>> query, string formSelector, int? formIndex, Uri url, NameValueCollection data) =>
            HttpQuery.Return(
                from html in query
                select Submit(html.Client, html.Content, formSelector, formIndex, url, data));

        public static HttpQuery Submit(this IHttpClient http, ParsedHtml html, string formSelector, NameValueCollection data) =>
            Submit(http, html, formSelector, null, null, data);

        public static HttpQuery Submit(this IHttpClient http, ParsedHtml html, int formIndex, NameValueCollection data) =>
            Submit(http, html, null, formIndex, null, data);

        public static HttpQuery SubmitTo(this IHttpClient http, Uri url, ParsedHtml html, string formSelector, NameValueCollection data) =>
            Submit(http, html, formSelector, null, url, data);

        public static HttpQuery SubmitTo(this IHttpClient http, Uri url, ParsedHtml html, int formIndex, NameValueCollection data) =>
            Submit(http, html, null, formIndex, url, data);

        internal static HttpQuery Submit(IHttpClient http,
            ParsedHtml html,
